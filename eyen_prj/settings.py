"""
Django settings for eyen_prj project.
...
SECRET_KEY = 'django-insecure-k^_k6%&6o7p3s^2x4&ibvsp1)@&f)d!33u%&cy#xp%-oc=8ilh'
...
WSGI_APPLICATION = 'eyen_prj.wsgi.application'

AUTH_USER_MODEL = 'accounts.Account' # defining the  custom models
...
STATICFILES_DIRS = [
    'eyen_prj/static',      # os.path.join(BASE_DIR,'static')
]
